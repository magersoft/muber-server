...
export interface Mutation {
  ...
  RequestEmailExist: RequestEmailExistResponse;
  RequestEmailVerification: RequestEmailVerificationResponse;
...
export interface RequestEmailExistMutationArgs {
  email: string;
}
...
export interface RequestEmailExistResponse {
  ok: boolean;
  error: string | null;
  exist: boolean;
}
...
export interface ToggleThemeModeResponse {
  ok: boolean;
  error: string | null;
}
